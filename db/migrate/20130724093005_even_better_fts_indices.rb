class EvenBetterFtsIndices < ActiveRecord::Migration
  ...
  def change
    ...
    execute "CREATE INDEX CONCURRENTLY decisions_fts_idx_after_jun1 ON decisions USING gin(to_tsvector('english', text)) WHERE promulgated_on >= '2013-06-01' OR reported = 't'"
